...
(function () {
  ...
  function setSvgIcon(type = "open") {
    if (type === "open") {
      ...
      if (fallbackCloseIcon) fallbackCloseIcon.style.display = "none";
    } else {
      // Hide open icon (image and fallback)
      const openIcon = document.getElementById("openIcon");
      const fallbackOpenIcon = document.getElementById("fallbackOpenIcon");
      if (openIcon) openIcon.style.display = "none";
      if (fallbackOpenIcon) fallbackOpenIcon.style.display = "none";
      ...
      const closeIcon = document.getElementById("closeIcon");
      const fallbackCloseIcon = document.getElementById("fallbackCloseIcon");
      if (closeIcon && closeIcon.complete && closeIcon.naturalWidth > 0) {
        closeIcon.style.display = "block";
        if (fallbackCloseIcon) fallbackCloseIcon.style.display = "none";
      } else if (fallbackCloseIcon) {
        fallbackCloseIcon.style.display = "block";
        if (closeIcon) closeIcon.style.display = "none";
      }
    }
  }
